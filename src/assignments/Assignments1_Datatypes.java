...
public class Assignments1_Datatypes {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
				...
				boolean HasPlacedAnOrder=true;
				boolean HasNotPlacedAnOrder=false;
				System.out.println("Whether a customer has placed an order: "+ HasPlacedAnOrder);
				...
				float CoordinatesOfALocationLatitude= 37.7749f;
				float CoordinatesOfALocationLongitude= -122.4194f;
				
				System.out.println("Coordinates of a location"+ CoordinatesOfALocationLatitude);
				System.out.println("Coordinates of a location"+ CoordinatesOfALocationLongitude);
		
		        // 7 Person's marital status: true or false
				boolean maritalStatusMarried = true;
				boolean maritalStatusUnMarried = false;
				
				System.out.println("Person's marital status:"+maritalStatusMarried);
				System.out.println("Person's marital status:"+maritalStatusUnMarried);	
